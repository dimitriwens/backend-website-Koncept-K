...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category_description: Schema.Attribute.Text & Schema.Attribute.Required;
...
export interface ApiColorColor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    color_visible: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    product_brand: Schema.Attribute.Relation<'oneToOne', 'api::brand.brand'>;
    ...
    > &
      Schema.Attribute.Required;
    product_material: Schema.Attribute.Relation<
      'oneToOne',
      'api::material.material'
    >;
...
export interface ApiSizeSize extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::size.size'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    size_name: Schema.Attribute.String & Schema.Attribute.Required;
    size_visible: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTypeType extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::type.type'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    type_type: Schema.Attribute.String & Schema.Attribute.Required;
    type_visible: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
